...
import { idlFactory } from './team4_social.did.js';
export { idlFactory } from './team4_social.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TEAM4_SOCIAL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./team4_social.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the team4_social canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./team4_social.did.js")._SERVICE>}
 */
export const team4_social = createActor(canisterId);
